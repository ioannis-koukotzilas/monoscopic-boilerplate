...
if (!function_exists('monoscopic_woocommerce_wrapper_before')) {
	/**
	 * Before Content.
	 *
...
if (!function_exists('monoscopic_woocommerce_wrapper_after')) {
	/**
	 * After Content.
	 *
 ...
 *
	<?php
		if ( function_exists( 'monoscopic_woocommerce_header_cart' ) ) {
			monoscopic_woocommerce_header_cart();
		}
	?>
 */

if (!function_exists('monoscopic_woocommerce_cart_link_fragment')) {
	/**
	 * Cart Fragments.
	 *
...
if (!function_exists('monoscopic_woocommerce_cart_link')) {
	/**
	 * Cart Link.
	 *
	...
	{
	?>
		<a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="<?php esc_attr_e('View your shopping cart', 'monoscopic'); ?>">
			<?php
			$item_count_text = sprintf(
				/* translators: number of items in the mini cart. */
				_n('%d item', '%d items', WC()->cart->get_cart_contents_count(), 'monoscopic'),
